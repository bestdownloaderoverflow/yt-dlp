...
Usage:
  python3 scripts/test_ipv6_tiktok.py                           # Test default via IPv6 langsung
  python3 scripts/test_ipv6_tiktok.py --proxy socks5h://...    # Test via proxy tertentu (misal WARP IPv6)
  python3 scripts/test_ipv6_tiktok.py --count 10               # Jalankan 10 request berturut-turut
"""
